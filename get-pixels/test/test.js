...
test("get-url png img", function (t) {
  var url =
    "https://raw.githubusercontent.com/scijs/get-pixels/master/test/test_pattern.png";
...
test("get-url jpg img", function (t) {
  var url =
    "https://raw.githubusercontent.com/scijs/get-pixels/master/test/test_pattern.jpg";
  getPixels(url, function (err, pixels) {
    if (err) {
      console.log("Error:", err);
      t.error(err, "failed to read web image data");
...
test("get-url gif img", function (t) {
  var url =
    "https://raw.githubusercontent.com/scijs/get-pixels/master/test/test_pattern.gif";
  getPixels(url, function (err, pixels) {
    if (err) {
      console.log("Error:", err);
      t.error(err, "failed to read web image data");
